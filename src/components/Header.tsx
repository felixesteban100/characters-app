...
function Header({ children }: HeaderProps) {
    ...
    return (
        <Sheet>
            <div className={cn(`flex justify-between ${showBackground === false ? ' bg-secondary/50' : 'bg-secondary'} items-center px-5 py-2 gap-5 sticky top-0 z-[20] transition duration-500`)}>
