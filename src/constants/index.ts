...
export function teamIMG(teamName: string) {
  ...
  switch (teamName) {
    case "Avengers":
      return [
        "https://cdn.marvel.com/u/prod/marvel/i/mg/9/60/6451109edb7ed/clean.jpg",
        "https://comicvine.gamespot.com/a/uploads/scale_small/10/103530/6410591-qwadf.jpg",
        "https://images.comicbooktreasury.com/wp-content/uploads/2022/04/The-Avengers-100-Avengers-Reading-Order-705x470.jpg",
        "https://cdn.mos.cms.futurecdn.net/DBi5Vv6sJr3HNzyWrUCgK6.jpg",
        "https://storage.googleapis.com/hipcomic/p/1ac894c3ed9eb207973eaae05a672bc5-800.jpg",
      ];

    case "Justice League":
      return [
        "https://i.pinimg.com/564x/5a/75/4b/5a754b3b2eba4bb6784f682003958383.jpg",
        "https://images.comicbooktreasury.com/wp-content/uploads/2021/09/DC-Comics-Omnibus.jpg",
        "https://m.media-amazon.com/images/I/91U157yeMWL._AC_UF1000,1000_QL80_.jpg",
      ];

    case "Justice League (Original)":
      return [
        "https://i.pinimg.com/564x/5a/75/4b/5a754b3b2eba4bb6784f682003958383.jpg",
        "https://ew.com/thmb/rN81QrzfrGBmgc70AZer-40EuUw=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/000265163hr-2000-63d9a54c0aa54b3a8f18494feb0319f2.jpg",
        "https://m.media-amazon.com/images/I/91EmslIilGL._AC_UF1000,1000_QL80_.jpg",
      ];

    case "Fantastic Four(Original)":
      return [
        "https://www.writeups.org/wp-content/uploads/Ultimate-Fantastic-Four-Marvel-Comics-a.jpg",
        "https://comicvine.gamespot.com/a/uploads/scale_small/12/124259/8113336-fantastic_four_vol_6_1_dell%27otto_exclusive_variant_textless.jpg",
        "https://i.pinimg.com/736x/88/73/ab/8873ab9f66f9283d1c5cf08a708818c1--marvel-dc-comics-marvel-art.jpg",
        "https://comicartcommunity.com/gallery/data/media/248/ULTIMATE_FANTASTIC_FOUR_06_Dale_Keown.jpg",
      ];

    case "Fantastic Four":
      return [
        "https://preview.redd.it/amtkskhm6jp71.jpg?width=640&crop=smart&auto=webp&s=5210447223f321889ad6f663e6bf856629c6df0a",
        "https://image-pastemagazine-com-public-bucket.storage.googleapis.com/wp-content/uploads/2022/06/20083956/imageedit_21_3331830624.jpg",
        "https://64.media.tumblr.com/464abc83819120e211e68406484b29f1/45f70a9e4221b978-6c/s640x960/b152216c6aaa9a46272a9ac1eb0f298c87fb40ce.jpg",
      ];

    case "X-Men":
      return [
        "https://kevinreviewsuncannyxmen.files.wordpress.com/2014/06/all-new-x-men-covers.jpg",
        "https://ew.com/thmb/oFPkeEilVT2jx61rxY0Ufkgqg7s=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/X-Men-Animated-Series-a8660bf353234b329fe63b226a603d38.jpg",
        "https://cdn.mos.cms.futurecdn.net/rFsFmxwHKvLKRTtQZCbjkR.jpg",
      ];

    case "Illuminati":
      return [
        "https://static1.moviewebimages.com/wordpress/wp-content/uploads/2022/05/Illuminati.jpg",
      ];

    case "Batman Family":
      return [
        "https://images2.alphacoders.com/440/440969.jpg",
        "https://i.imgur.com/P7cQxZI.png",
        "https://i.imgur.com/Olqppfi.png",
        "https://i.imgur.com/ya61PSJ.jpg",
        "https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/060b7e2a-716b-4521-87d4-f4051f999665/dcudxtp-46860270-438b-4b7c-b8b3-2c9937338ca6.png/v1/fill/w_1280,h_902,q_80,strp/the_batman_family_by_mrrizeag_dcudxtp-fullview.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..zUhlIJMKD8PGltxHXnqWibS-954x9_Y264f6MUjOsqg",
        "https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/a8be3d4c-a19e-4532-8e2e-7144eef91b20/dcgiv1l-5eb28848-6bec-4d42-a533-72b27a78b1cd.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..eu-_aG5u1ZYWfbJKqgIm4Gw7OvE54_uEKvYu7FPDXeE",
      ];

    case "Teenage Mutant Ninja Turtles":
      return [
        "https://www.entertainmentearth.com/news/wp-content/uploads/2015/03/teenage-mutant-ninja-turtles-660x400.jpg",
        "https://m.media-amazon.com/images/I/91L4+Vf8YWL._AC_UF1000,1000_QL80_.jpg",
        "https://m.media-amazon.com/images/I/91JJ2KVqZxL._AC_UF1000,1000_QL80_.jpg",
        "https://dyn.media.forbiddenplanet.com/G6ZsQHigqNP4v8OumhRGzMRL9OA=/fit-in/1500x1500/https://media.forbiddenplanet.com/products/50/79/190b46be00d1ee8197156b731327e30c105a.jpg",
      ];

    case "Guardians of the Galaxy":
      return [
        "https://cdn.marvel.com/u/prod/marvel/i/mg/6/e0/5c3f94442d3e9/clean.jpg",
        "https://images5.alphacoders.com/872/872052.jpg",
        "https://s33525.pcdn.co/wp-content/uploads/2021/02/STL181935-1.jpg",
        "https://cdn.kobo.com/book-images/d6403f38-b70d-4db5-97ef-11b29f6658c5/1200/1200/False/guardians-of-the-galaxy-vol-1.jpg",
      ];

    case "Teen Titans":
      return [
        "https://13thdimension.com/wp-content/uploads/2016/09/640z.jpg",
        "https://insidepulse.com/wp-content/uploads/2023/04/Tales-of-The-Titans-1-A-scaled.webp",
      ];

    case "Future Foundation":
      return [
        "https://media.wired.com/photos/5932b9ebd80dd005b42b03b1/master/w_2560%2Cc_limit/FF_1_Cover-660.jpg",
        "https://staticg.sportskeeda.com/editor/2022/07/3d896-16591198229869-1920.jpg",
        "https://comicaption.files.wordpress.com/2011/11/fantasticfour600a1.jpg",
      ];

    case "Symbiotes":
      return [
        "https://celebrity.fm/wp-content/uploads/2022/05/Who-is-the-God-of-symbiote-celebrityfm.jpg",
        "https://i.pinimg.com/originals/a7/d8/4b/a7d84bf9fe6b44529f3b17555ab07a5d.jpg",
      ];

    case "Flash Family":
      return [
        "https://w0.peakpx.com/wallpaper/618/788/HD-wallpaper-flash-family-dceu-arrowverse-dc-dc-comics.jpg",
        "https://i0.wp.com/www.comicsbeat.com/wp-content/uploads/2020/05/EX_IIaHUYAAE6Aa.jpg?ssl=1",
      ];

    case "Suicide Squad":
      return [
        "https://m.media-amazon.com/images/I/A1nLFV0is9L._AC_UF1000,1000_QL80_.jpg",
        "https://oyster.ignimgs.com/wordpress/stg.ign.com/2019/09/suicide_squad_detail_-_publicity_-_embed_-_2019.jpg",
      ];
    ...
    case "Demon Slayer":
      return [
        ...
        "https://www.nme.com/wp-content/uploads/2023/01/demon-slayer-season-3-swordsmith-village-arc-key-art@2000x1270.jpg",
        "https://m.media-amazon.com/images/M/MV5BZGVlNzJkN2QtYmQ2YS00MmUzLTk0MjYtOWQ2YmVhZjMyNGZjXkEyXkFqcGdeQXVyOTA2OTk0MDg@._V1_.jpg",
      ];

    case "Ben 10":
      return [
        "https://i.pinimg.com/originals/56/81/f2/5681f244b6d26283fa5e535e176613e9.jpg",
        "https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/5c014b4c-5206-41f3-a2f2-d24f96e3b43a/dfhwk74-83d3082a-b435-4dc9-81f6-b42aba70ee97.gif?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..kPC69MFKByFc_2E4X2na6DpU4o4zgqzDGIt-Idnsnaw",
      ];

    case "New Guardians":
      return [
        "https://images.squarespace-cdn.com/content/v1/593f201de3df288fc6465e6f/1536788587165-DQC6TWZURXFEC7J7TBPQ/a9e6fbdbc85018e3a2bb7b3809a0caa2.jpg",
        "https://digitalspyuk.cdnds.net/12/40/comics_new_guardians_2.jpg",
        "https://e1.pxfuel.com/desktop-wallpaper/769/825/desktop-wallpaper-i-redesigned-kyle-s-white-lantern-suit-original-art-by-tyler-kirkham-from-green-lantern-new-guardians-%E2%80%A6-lantern-corps-suits.jpg",
      ];

    case "Lantern Corps":
      return [
        "https://qph.cf2.quoracdn.net/main-qimg-2673d6d36ab6b962fecea97a8dc6f231-lq",
      ];

    case "Hulk Family":
      return [
        "https://i.pinimg.com/originals/c4/6b/4c/c46b4cad4416a382de72896f9e0d5b9f.jpg",
        "https://comicvine.gamespot.com/a/uploads/original/11134/111347244/7079315-4150626068-96446.jpg",
        "https://i.pinimg.com/736x/4e/e0/1f/4ee01f483be7ac031996b51e30e8e8e1--hulk-hulk-walter-obrien.jpg",
      ];
...
export const batmanandSpider_manObj: Character[] = [
  ...
  },
  {
    ...
    connections: {
      groupAffiliation:
        "Member of the Avengers, formerly member of Outlaws, alternate Fantastic Four, Spider-Army, Young avengers, Future Foundation",
      relatives:
    ...
    images: {
      ...
      symbiote:
        "https://i.pinimg.com/564x/b6/e5/f2/b6e5f294604db206c0c617000ba28eb7.jpg",
    },
...
export const DEFAULT_HERO_SECTION: HeroSection = {
  imgs: /*  window.innerWidth < 700 
    ...
    "https://images7.alphacoders.com/133/1330960.jpeg",
    ...
    "https://images5.alphacoders.com/371/371733.jpg",
    "https://images5.alphacoders.com/109/1098014.jpg",
  ]
...
export function getSearchParamsFormatted(searchParams: URLSearchParams) {
  return {
    ...
    includeNameOrExactName:
      searchParams.get("includeNameOrExactName") === "true",
    characterOrFullName: searchParams.get("characterOrFullName") === "true",
    charactersFilteredIds:
      searchParams.get("charactersFilteredIds") ??
      JSON.stringify([620, 70, 846]),
    selectedCharacterId: parseInt(
      searchParams.get("selectedCharacterId") ?? "620"
    ),
